...
type HelloRequest struct {
	...
	B2 bool `protobuf:"varint,2,opt,name=b2,proto3" json:"b2,omitempty"`
}
...
func (x *HelloRequest) GetB1() bool {
	if x != nil {
		return x.B1
	}
	return false
...
func (x *HelloRequest) GetB2() bool {
	if x != nil {
		return x.B2
	}
	return false
...
var file_api_helloworld_v1_greeter_proto_rawDesc = []byte{
	...
	0x0a, 0x02, 0x62, 0x31, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x02, 0x62, 0x31, 0x12, 0x0e,
	0x0a, 0x02, 0x62, 0x32, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x02, 0x62, 0x32, 0x22, 0x26,
	...
	0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x42, 0x4e, 0x0a, 0x1c, 0x64, 0x65,
